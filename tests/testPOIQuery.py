...
query_schema = POIQuerySchema(
    latitude=33.4249386,
    longitude=-111.9346209,
    travel_radius=40000,
    feature_types=["Garden", "Shopping", "Museum"],
    result_limit=10,
    visited_places=["itp:Palm_Village_Shopping_Center_Tempe_14863", "itp:Tempe_Shopping_Center_Tempe_15113"]
)

print(query_schema.getQuerySchema())
